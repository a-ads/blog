  ...
  <div className='c-footer'> 
    <div className='c-footer__container l-container'> 
      ...
      <div className='c-footer__social-buttons'>
        <a href='https://www.facebook.com/aads.network/' target='_blank'><img src='images/fb.svg' alt=''/></a>
        <a href='https://twitter.com/aads_network' target='_blank'><img src='images/twitter.svg' alt=''/></a>
        {/* <a href='#'><img src='/images/medium.svg' alt=''/></a>
        <a href='#'><img src='/images/reddit.svg' alt=''/></a> */}
        <a href='https://bitcointalk.org/index.php?topic=140822' target='_blank'><img src='images/btc.svg' alt=''/></a>
      </div>
