...
export default () => (
  <div className='c-footer'> 
    <div className='c-footer__container l-container'> 
      <div className='c-footer__links'><a href='https://a-ads.com/about_us'>About A-ADS</a></div>
      <div className='c-footer__social-buttons'>
        ...
        <a href='https://bitcointalk.org/index.php?topic=140822' target='_blank'><img src={withPrefix('/images/btc.svg')} alt=''/></a>
      </div>
